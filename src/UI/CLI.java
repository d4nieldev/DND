...
public class CLI {
    public static void main(String[] args){
        if(args.length > 0) {
            ...
            TileFactory tf = new TileFactory(System.out::println);
            int i = 1;
            ...
            GameManager gameManager = new GameManager(playerSelection, pathToLevels, System.out::println);
            gameManager.playGame();
        }
        else
            System.out.println("You did not specify a path to levels dir");
    }
}
